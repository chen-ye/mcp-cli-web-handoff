...
import { delegateWebResearchSchema, handleDelegateWebResearch, type ToolDependencies } from '../../mcp-server/src/tools';
...
test.describe('mcp-tools unit tests', () => {
  ...
  test('should return a suspension message when handled', async () => {
